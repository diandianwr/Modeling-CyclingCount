...
\setcounter{page}{-1}
\abstract{%
A bikeable environment has been proven to benefit cycler’s heath as well as contribute to a sustainable transportation system. Thus policy makers and urban planners through out the word have been promoting bicycling. City of Seattle in the northwest has been implementing new policies and programs to create a bikeable city and aimed to quadruple ridership by 2030. Empirically confirming such growth in Seattle will help justify current and future investment in bicycle infrastructure and programs in Seattle.  This study uses Seattle metropolitan area cyclist count data to quantify the trend and examine the relationship between several seasonal and weather factors and bicycle ridership. Seasonal and weather variables are investigated and discussed symmetrically as well as how variable should be transformed. And we compared different a regression models to capture the relationship such as non-linearity, discontinuity and interaction between bike count and various factors. Results are interpreted with intuitive visualization using counterfactual simulations. Then a predictive model was proposed to estimate daily count in the future. Autoregressive Integrated Moving Average (ARIMA) model is used to take autocorrelation into account. The predicative performance is proven through cross validation. Finally, we applied the model to data collected at other locations in Seattle.  This research will help policy makers and transportation planners to understand the factors that could drive the bike demand and their predicative impact on bike travel behavior.}
